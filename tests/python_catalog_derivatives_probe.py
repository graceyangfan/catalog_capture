"""Probe a live or fixture catalog for Step 1 Binance perp WS families."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Probe quotes, mark prices, index prices, and funding rates written by "
            "nautilus_catalog_capture (Step 1 Binance perp WS profile)."
        ),
    )
...
def main() -> int:
    ...
    print("Python derivatives catalog probe succeeded (Step 1)")
